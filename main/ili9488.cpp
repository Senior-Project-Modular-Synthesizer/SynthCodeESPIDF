    ...
    esp_lcd_panel_handle_t *ret_panel)
{
	...
	else if (panel_dev_config->bits_per_pixel == 24)
	{
		ili9488->color_mode = ILI9488_COLOR_MODE_24BIT;
	}
    else
    {
    ...
    ili9488->io = io;
    ili9488->reset_gpio_num = (gpio_num_t)panel_dev_config->reset_gpio_num;
